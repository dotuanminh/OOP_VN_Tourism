package hust.soict.globalict.backend.tourism.naturalattraction.bodyofwater;

import hust.soict.globalict.backend.rdfconstant.ObjectToCollect;
import hust.soict.globalict.backend.rdfconstant.Prefix;
import hust.soict.globalict.backend.tourism.naturalattraction.NaturalAttraction;
